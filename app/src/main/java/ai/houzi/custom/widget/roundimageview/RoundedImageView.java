...
package ai.houzi.custom.widget.roundimageview;
...
public class RoundedImageView extends ImageView {
    ...
    private Drawable mBackDrawable, mFrontDrawable;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBackDrawable = a.getDrawable(R.styleable.RoundedImageView_riv_src_back);
        if (mBackDrawable == null) {
            mBackDrawable = new ColorDrawable(Color.parseColor("#DDDDDD"));
        }
        mFrontDrawable = a.getDrawable(R.styleable.RoundedImageView_riv_src_front);
        if (mFrontDrawable == null) {
            mFrontDrawable = getDrawable();
        }
        mSwitchDuration = a.getInt(R.styleable.RoundedImageView_riv_switch_duration, 1000);
        a.recycle();
    }
    ...
    public void switchBack() {
        ObjectAnimator rotationY = ObjectAnimator.ofFloat(this, "rotationY", 0, 180);
        rotationY.setDuration(mSwitchDuration);
        rotationY.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                long currentPlayTime = animation.getCurrentPlayTime();
                if (currentPlayTime >= mSwitchDuration / 2) {
                    setImageDrawable(mBackDrawable);
                }
            }
        });
        rotationY.start();
    ...
    public void switchFront() {
        ObjectAnimator rotationY = ObjectAnimator.ofFloat(this, "rotationY", 180, 0);
        rotationY.setDuration(mSwitchDuration);
        rotationY.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
